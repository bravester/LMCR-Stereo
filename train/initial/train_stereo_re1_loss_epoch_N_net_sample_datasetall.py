...
import data_load_datasetall.stereo_datasets as datasets

import evaluate_stereo_datasatall
    ...
    while should_keep_training:
        for epoch in range(max_epoch):
            for i_batch, (_, *data_blob) in enumerate(tqdm(dataloader)):
                ...
                logger.push(metrics,worklog, epoch,max_epoch,loss.item(),time_train_passed)
                ...
                if total_steps % validation_frequency == validation_frequency - 1:
                    ...
                    save_txt = args.log_dir + '/' + args.log_dir + args.save_txt
                    results = evaluate_stereo_datasatall.validate_things(model.module, save_txt, total_steps + 1,
        ...
        if total_steps >= 10000:
            ...
            worklog.info(f"total_steps {total_steps}"+f"Saving file {save_path}")
            torch.save(model.state_dict(), save_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--training_data_path', default='/root/autodl-tmp/CREStereo_PyTorch_re3/SceneFlow_all', help='use mixed precision')
    parser.add_argument('--log_dir', default='./train_stereo_log_cres_loss_lr_N_net_sample_datasetall_b4_i20000', help='use mixed precision')
    ...
    parser.add_argument('--accumulation_steps', default=4, help='batch size disguised expansion accumulation_steps times')
