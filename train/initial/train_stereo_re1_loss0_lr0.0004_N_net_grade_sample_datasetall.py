...
from model.cres.useful.nets_grade import Model
# from dataset import CREStereoDataset
import data.data_load_datasetall.stereo_datasets as datasets

import evaluate.evaluate_stereo_datasatall_net_grade as eva
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/41991/train_stereo_log_cres_loss0_N_net_grade_sample_datasetall_b4_i20000', help='use mixed precision')
