...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/train_stereo_log_cres_loss_acc_lr_N_net_sample_datasetall_b4_i20000', help='use mixed precision')
