...
from model.cres.useful.nets_2to1_add_pre_reduce import Model
# from dataset import CREStereoDataset
import data.data_load_datasetall.stereo_datasets as datasets

import evaluate.evaluate_stereo_datasatall_2to1_add_pre_reduce as eva
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/train_stereo_log_cres_loss_N_net_2to1_add_pre_reduce_sample_datasetall_b4_i20000', help='use mixed precision')
