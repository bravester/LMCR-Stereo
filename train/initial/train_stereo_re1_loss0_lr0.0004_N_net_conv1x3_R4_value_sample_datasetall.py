...
from model.cres.useful.nets_res4_conv1x1x3_R4_value import Model
# from dataset import CREStereoDataset
import data.data_load_datasetall.stereo_datasets as datasets

import evaluate.evaluate_stereo_datasatall_conv1x3_R4_value as eva
...
def sequence_loss(flow_preds, flow_gt, valid, loss_gamma=0.9, max_flow=700):
    ...
    for i in range(n_predictions):
        ...
        a=i_weight * (valid.unsqueeze(1) * i_loss)
