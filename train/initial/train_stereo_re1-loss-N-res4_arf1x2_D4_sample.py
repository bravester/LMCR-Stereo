...
def main(args):
    ...
    # model / optimizer
    model = Model(
        max_disp=args.max_disp, batch_size=args.batch_size_single,mixed_precision=args.mixed_precision, test_mode=False
    )
    ...
    while should_keep_training:
        ...
        for i_batch, (_, *data_blob) in enumerate(tqdm(dataloader)):
            ...
            if total_steps % validation_frequency == validation_frequency - 1:
                ...
                results = evaluate_stereo_arf1x2_D4.validate_things(model.module, save_txt, total_steps + 1,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./train_stereo_log_cres_loss_N_res4_arf1_D4_sample_b4_i20000', help='use mixed precision')
