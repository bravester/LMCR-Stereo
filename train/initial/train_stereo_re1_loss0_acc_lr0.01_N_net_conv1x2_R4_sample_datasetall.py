...
from model.cres.useful.nets_res4_conv1x1x2_D4_frediction0 import Model
# from dataset import CREStereoDataset
import data.data_load_datasetall.stereo_datasets as datasets

import evaluate.evaluate_stereo_datasatall_conv1x2_D4_frediction0 as eva
    ...
    while should_keep_training:
        ...
        for i_batch, (_, *data_blob) in enumerate(tqdm(dataloader)):
            ...
            if total_steps % validation_frequency == validation_frequency - 1:
                ...
                save_txt = args.log_dir + '/' + time.strftime('%m-%d-%H') + args.save_txt
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/41991/train_stereo_log_cres_loss0_acc_lr0.0004_N_net_conv1x2_R4_sample_datasetall_b4_i20000', help='use mixed precision')
