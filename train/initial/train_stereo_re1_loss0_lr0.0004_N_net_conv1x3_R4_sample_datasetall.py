...
from model.cres.useful.nets_res4_conv1x1x3_R4 import Model
...
def sequence_loss(flow_preds, flow_gt, valid, loss_gamma=0.9, max_flow=700):
    ...
    for i in range(n_predictions):
        ...
        # a1= i_weight * i_loss[valid.bool()]
        a2=valid.unsqueeze(1)
        a1=valid.unsqueeze(1) * i_loss
        a= (valid.unsqueeze(1) * i_loss).mean()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/41991/train_stereo_log_cres_loss0_lr0.0004_N_net_conv1x1x3_R4diff_sample_datasetall_b4_i20000', help='use mixed precision')
