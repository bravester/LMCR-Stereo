...
def main(args):
    ...
    while should_keep_training:
        ...
        for i_batch, (_, *data_blob) in enumerate(tqdm(dataloader)):
            ...
            flow_predictions = model(left, right,iters=args.train_iters)
            assert model.training
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/train_stereo_log_cres_loss_N_raft_stereo_sample_datasetall_b4_i20000', help='use mixed precision')
