...
import \
    evaluate.pre_train_model_sceneflow.evaluate_stereo_datasatall_feature_2to1_add_pre_zeroresize_grade_dw32_16_8_loop_end_aug_all as eva
    ...
    while should_keep_training:
        ...
        for i_batch, (_, *data_blob) in enumerate(tqdm(dataloader)):
            ...
            if total_steps % validation_frequency == validation_frequency - 1:
                ...
                results = eva.validate_things(model.module, worklog=worklog, save_txt=save_txt, tall=t0,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', default='LMCR-Stereo', help="name your experiment")
    parser.add_argument('--restore_ckpt', help="restore checkpoint")
    parser.add_argument('--mixed_precision', action='store_true', help='use mixed precision')

    parser.add_argument('--training_data_path', default='./SceneFlow_all', help='use mixed precision')
    parser.add_argument('--log_dir',
                        default='./results/feature_2to1_apre_zero_gi32_16_8_3225_loop_end_allfc_b4_i300000_test')
    parser.add_argument('--log_model_dir',
                        ...
                        help='model save pth')
    parser.add_argument('--save_txt', default='FlyingThings3D (TEST).txt')
    parser.add_argument('--log_level', default='logging.INFO')
    parser.add_argument('--seed', type=int, default=0)

    # Training parameters
    parser.add_argument('--base_lr', type=float, default=4.0e-4)
    parser.add_argument('--nr_gpus', type=int, default=1)
    parser.add_argument('--batch_size_single', type=int, default=4)
    parser.add_argument('--n_total_epoch', type=int, default=100)
    parser.add_argument('--minibatch_per_epoch', type=int, default=200)
    parser.add_argument('--model_save_freq_epoch', type=int, default=10)
    ...
    parser.add_argument('--train_iters', type=int, default=[24, 3, 2, 2, 5],
                        help="number of updates to the disparity field in each forward pass.")
    parser.add_argument('--wdecay', type=float, default=.00001, help="Weight decay in optimizer.")

    # Validation parameters
    parser.add_argument('--valid_iters', type=int, default=[24, 3, 2, 2, 5],
