...
from model.ablations.nets_feature_pre_zeroresize_dw32_16_8_loop_end_light_small import Model
...
import evaluate.ablations.evaluate_stereo_datasatall_feature_2to1_add_pre_zeroresize_grade_dw32_16_8_loop_end_light_small_aug_all as eva
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/N_net_feature_2to1_apre_zero_gi32_16_8_light_small_11112_loop_end_allfc_b4_i40000_test', help='use mixed precision')
    ...
    parser.add_argument('--train_iters', type=int, default=[1,1,1,12],
                        help="number of updates to the disparity field in each forward pass.")
    parser.add_argument('--wdecay', type=float, default=.00001, help="Weight decay in optimizer.")

    # Validation parameters
    parser.add_argument('--valid_iters', type=int, default=[1,1,1,12],
