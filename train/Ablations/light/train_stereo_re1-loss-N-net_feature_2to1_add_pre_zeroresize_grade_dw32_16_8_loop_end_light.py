...
# from model.cres.useful.L37671_211.nets_2to1_add_pre_zeroresize_grade_dw32_16_8_loop_end import Model
...
def main(args):
    ...
    validation_frequency_test=2000
    ...
    while should_keep_training:
        ...
        for i_batch, (_, *data_blob) in enumerate(tqdm(dataloader)):
            ...
            if total_steps % validation_frequency_test == validation_frequency_test - 1:
                ...
                results2 = eva.validate_things(model.module,worklog=worklog, save_txt=save_txt, tall= t0,total_steps=total_steps + 1,
                                                                  iters=args.valid_iters,sum_sample=100)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./results/N_net_feature_2to1_apre_zero_gi32_16_8_light_4224_loop_end_allfc_b4_i300000_true', help='use mixed precision')
    ...
    # [5,3.1,4] ==>[20,12,4,1]
    parser.add_argument('--train_iters', type=int, default=[4,2,2,4],
                        help="number of updates to the disparity field in each forward pass.")
    parser.add_argument('--wdecay', type=float, default=.00001, help="Weight decay in optimizer.")

    # Validation parameters
    parser.add_argument('--valid_iters', type=int, default=[4,2,2,4],
