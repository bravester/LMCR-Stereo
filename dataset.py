...
class CREStereoDataset(Dataset):
    ...
    def get_disp(self, path):
        # disp1 =Image.open(path)
        # disp= disp1.convert('RGB')
    ...
    def __getitem__(self, index):
        ...
        # left_img = left_img1.convert('RGB')
        # right_img = right_img2.convert('RGB')
        ...
        # left_disp =left_disp.transpose(2, 0, 1)
        # disp_mask =left_disp.transpose(2, 0, 1)
