...
class BasicEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        a1= x.shape   #[8,3,384,512]
        x = self.conv1(x)
        a2 = x.shape   #[8,64,192,256]
        x = self.norm1(x)
        a3 = x.shape    #[8,64,192,256]
        x = self.relu1(x)
        a4 = x.shape    #[8,64,192,256]

        x = self.layer1(x)
        a5 = x.shape   # [8,64,192,256]
        x = self.layer2(x)
        a6 = x.shape    # [8,96,96,128]
        x = self.layer3(x)
        a7 = x.shape    # [8,128,96,128]==>[8,128,48,64]

        x = self.conv2(x)
        a8 = x.shape    # [8,256,96,128]==>[8,128,48,64]
