...
from model.pre_train_model_sceneflow.nets_2to1.crestereo import CREStereo, autocast
...
def validate_middlebury(model, input_image, worklog, save_txt, tall, total_steps, infer_level=1, iters=32, split='F',
    ...
    worklog.info(
        f"Validation Middlebury{split}_{infer_level}: EPE: {epe}, D0.5: {d5}, D1: {d1},D2: {d2},D4: {d4},validate_time_mean:{validate_time_mean}")
